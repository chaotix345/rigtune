# Downgrade E2E: downgrade-040-to-030

- Verdict: **PASS**
- Run: 20260926T161035Z UTC, MC 26.2, a fresh scratch instance with rigtune-0.3.0+mc26.2.jar + fabric-api-0.161.0+26.2.jar + `e2e-downgrade-off-1.0.0.jar` (for 0.3.0's own Apply)
...
- New (reinstalled after it): `rigtune-0.4.0-dev+mc26.2.jar` version 0.4.0-dev+mc26.2, sha256 `4018fe03ee2164724f144f77abc829b3b73ac25e941e38f5c3c6aeb8778a9a12`
- "Written by 0.4" sets (plan review H-M1; `seeded.json`): `ws-a`, `ws-p`, `ws-b`, `ws-s`, `ws-w`, `ws-f`
- Client time: downgrade-old 29 s, downgrade-new 19 s
...
| Undo last reverted the newest undoable entry, recorded by 0.3.0 | PASS | plan undoOf c3e7a1f6-8d0b-4e2f-9b3c-7f5e6d349c17 (expected c3e7a1f6-8d0b-4e2f-9b3c-7f5e6d349c17), problem None, items [('REVERT', 'Render Distance: 8 → 12', None), ('REVERT', 'Max Framerate: 60 → 120', None), ('REVERT', 'Sodium: Chunk Update Threads: 2 → Default', None)]; 0.3.0 undo entries of it: [[('vanilla.renderDistance', 'APPLIED'), ('vanilla.maxFps', 'APPLIED'), ('sodium.performance.chunk_builder_threads', 'APPLIED')]]; planned but not undone: []; vanilla or mod changes skipped: [] |
...
| 0.4's staged ops (with projectId): applied by 0.3.0's helper, or dropped by its Undo last | PASS | ops (expected, last-apply, journal): {'0a4f3c1e-5b7d-4e2a-9c61-7d2f1b8e4a01': ('APPLIED', 'OK', ['APPLIED'])}; pending.json left: False |
