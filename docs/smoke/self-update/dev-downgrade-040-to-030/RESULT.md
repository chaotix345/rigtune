...
- Verdict: **PASS**
- Run: 20260926T050843Z UTC, MC 26.2, a fresh scratch instance with rigtune-0.3.0+mc26.2.jar + fabric-api-0.161.0+26.2.jar + `e2e-downgrade-off-1.0.0.jar` (for 0.3.0's own Apply)
...
- Client time: downgrade-old 32 s, downgrade-new 19 s
