# Undo after restart E2E: dev-undo-after-restart-030-wsb

- Verdict: **PASS**
- Run: 20260925T191415Z UTC, MC 26.2, rigtune-0.3.0-dev+mc26.2.jar + fabric-api-0.161.0+26.2.jar + e2e-disable-me-1.0.0.jar in a fresh scratch instance
- RigTune: `rigtune-0.3.0-dev+mc26.2.jar` version 0.3.0-dev+mc26.2, sha256 `d5b50dbcf982c5446b6167167d8bd5f8c218172a494f3628ff33577af6698f68`
- Added from the fake Modrinth: `e2e-added-1.0.0.jar` (project E2EAddMd); disabled: `e2e-disable-me-1.0.0.jar`
- B-M3, same instance: one Apply adds `e2e-first-1.0.0.jar` (project E2EFrst1), a second Apply adds `e2e-second-1.0.0.jar` (E2EScnd1); Undo this on the older one (entry 687530b9-4ec9-4ccd-9eea-1e25589d48e8; through the undo screen: True; controller method: RigTuneController.undoPlanFor)
- Client time: mod-apply 30 s, mod-undo 29 s, mod-check 19 s, entry-apply 26 s, entry-undo 27 s, entry-check 26 s
...
|---|---|---|
| the client exited normally and the helper finished | PASS | gradle exit 0, helper finished: True |
| the driver undid the last apply (two reverts after a restart) | PASS | error: None; undoOf: 60f6676f-7378-4c84-87d1-46b8ca3ade29; plan: [{'description': 'Disable e2e-added-1.0.0.jar', 'action': 'REVERT', 'reason': None, 'needsRestart': True, 'changeIds': ['e090f7ef-b909-4c22-9678-2badb820ad78'], 'opIds': []}, {'description': 'Re-enable e2e-disable-me-1.0.0.jar', 'action': 'REVERT', 'reason': None, 'needsRestart': True, 'changeIds': ['343d4f26-5dab-4b1a-990b-3262a11bf969'], 'opIds': []}] |
...
| history.json: the undo APPLIED, the apply's changes REVERTED | PASS | apply changes: {'343d4f26-5dab-4b1a-990b-3262a11bf969': 'REVERTED', 'e090f7ef-b909-4c22-9678-2badb820ad78': 'REVERTED'}; undo entries: ['60f6676f-7378-4c84-87d1-46b8ca3ade29']; undo changes: [('disable', 'e2e-added-1.0.0.jar', 'APPLIED', 'e090f7ef-b909-4c22-9678-2badb820ad78'), ('enable', 'e2e-disable-me-1.0.0.jar', 'APPLIED', '343d4f26-5dab-4b1a-990b-3262a11bf969')] |
...
| history.json: two new apply entries, the older adding e2e-first, both APPLIED | PASS | new entries: [('apply', '2026-09-25T19:16:05.050756600Z', [('file', 'enable', 'e2e-first-1.0.0.jar', 'APPLIED')]), ('apply', '2026-09-25T19:16:06.543450400Z', [('file', 'enable', 'e2e-second-1.0.0.jar', 'APPLIED')])] |
...
|---|---|---|
| the client exited normally and the helper finished | PASS | gradle exit 0, helper finished: True |
| the driver undid the older Apply only (one revert after a restart) | PASS | error: None; undoOf: 687530b9-4ec9-4ccd-9eea-1e25589d48e8 (older 687530b9-4ec9-4ccd-9eea-1e25589d48e8); via the undo screen: True; plan: [{'description': 'Disable e2e-first-1.0.0.jar', 'action': 'REVERT', 'reason': None, 'needsRestart': True, 'changeIds': ['73910331-0de5-457c-8bf5-8d4d34a5901a'], 'opIds': []}] |
...
| history.json: one undo of the older Apply, its change REVERTED, the newer APPLIED | PASS | undo entries of these applies: ['687530b9-4ec9-4ccd-9eea-1e25589d48e8']; undo changes: [('disable', 'e2e-first-1.0.0.jar', 'APPLIED', '73910331-0de5-457c-8bf5-8d4d34a5901a')]; older: {'73910331-0de5-457c-8bf5-8d4d34a5901a': 'REVERTED'}; newer: {'7a56f049-89aa-4358-925a-0ec8b9982706': 'APPLIED'} |
