# Self-update E2E: final-v020-to-040

- Verdict: **PASS**
- Run: 20260926T155536Z UTC, MC 26.2, rigtune-0.2.0+mc26.2.jar + fabric-api-0.161.0+26.2.jar in a fresh scratch instance
...
- Client time: update 30 s, verify 21 s
...
| last-apply.json: the update's two ops, all OK | PASS | results: [('DISABLE_FILE', 'rigtune-0.2.0+mc26.2.jar', 'OK'), ('ENABLE_FILE', 'rigtune-0.4.0-dev+mc26.2.jar', 'OK')] |
...
| the apply result was shown (rigtune.json lastShownApply) | PASS | lastShownApply 2026-09-26T15:56:16.323014900Z vs last-apply.json finishedAt 2026-09-26T15:56:16.323014900Z |
...
| history.json: the old version's own update, both changes APPLIED | PASS | entries: ['apply']; changes: [('file', 'disable', 'rigtune-0.2.0+mc26.2.jar', 'APPLIED'), ('file', 'enable', 'rigtune-0.4.0-dev+mc26.2.jar', 'APPLIED')]; statuses unchanged by the relaunch: True |
