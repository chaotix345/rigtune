# Undo after restart E2E: dev-undo-after-restart-040

- Verdict: **PASS**
- Run: 20260926T034003Z UTC, MC 26.2, rigtune-0.4.0-dev+mc26.2.jar + fabric-api-0.161.0+26.2.jar + e2e-disable-me-1.0.0.jar in a fresh scratch instance
- RigTune: `rigtune-0.4.0-dev+mc26.2.jar` version 0.4.0-dev+mc26.2, sha256 `bd2c93ae44b9c48a3708f1d4b0bddeb7e1dd2311292f0cd8d7d4f69c6d03f0a4`
- Added from the fake Modrinth: `e2e-added-1.0.0.jar` (project E2EAddMd); disabled: `e2e-disable-me-1.0.0.jar`
- B-M3, same instance: one Apply adds `e2e-first-1.0.0.jar` (project E2EFrst1), a second Apply adds `e2e-second-1.0.0.jar` (E2EScnd1); Undo this on the older one (entry 9cb52b78-fb31-4703-a4ec-87bfa7c8a77a; through the undo screen: True; controller method: RigTuneController.undoPlanFor)
- Client time: mod-apply 28 s, mod-undo 23 s, mod-check 19 s, entry-apply 23 s, entry-undo 23 s, entry-check 20 s
...
|---|---|---|
| the client exited normally and the helper finished | PASS | gradle exit 0, helper finished: True |
| the driver undid the last apply (two reverts after a restart) | PASS | error: None; undoOf: 273d553c-17f2-44e1-87ee-bf350dcdab3e; plan: [{'description': 'Disable e2e-added-1.0.0.jar', 'action': 'REVERT', 'reason': None, 'needsRestart': True, 'changeIds': ['4c7d133d-8a97-45f6-ad64-9f6875ae758d'], 'opIds': []}, {'description': 'Re-enable e2e-disable-me-1.0.0.jar', 'action': 'REVERT', 'reason': None, 'needsRestart': True, 'changeIds': ['0e7550e3-4738-4eac-936c-b1fb2dd7b686'], 'opIds': []}] |
...
| history.json: the undo APPLIED, the apply's changes REVERTED | PASS | apply changes: {'0e7550e3-4738-4eac-936c-b1fb2dd7b686': 'REVERTED', '4c7d133d-8a97-45f6-ad64-9f6875ae758d': 'REVERTED'}; undo entries: ['273d553c-17f2-44e1-87ee-bf350dcdab3e']; undo changes: [('disable', 'e2e-added-1.0.0.jar', 'APPLIED', '4c7d133d-8a97-45f6-ad64-9f6875ae758d'), ('enable', 'e2e-disable-me-1.0.0.jar', 'APPLIED', '0e7550e3-4738-4eac-936c-b1fb2dd7b686')] |
...
| history.json: two new apply entries, the older adding e2e-first, both APPLIED | PASS | new entries: [('apply', '2026-09-26T03:41:43.631602500Z', [('file', 'enable', 'e2e-first-1.0.0.jar', 'APPLIED')]), ('apply', '2026-09-26T03:41:45.120704700Z', [('file', 'enable', 'e2e-second-1.0.0.jar', 'APPLIED')])] |
...
|---|---|---|
| the client exited normally and the helper finished | PASS | gradle exit 0, helper finished: True |
| the driver undid the older Apply only (one revert after a restart) | PASS | error: None; undoOf: 9cb52b78-fb31-4703-a4ec-87bfa7c8a77a (older 9cb52b78-fb31-4703-a4ec-87bfa7c8a77a); via the undo screen: True; plan: [{'description': 'Disable e2e-first-1.0.0.jar', 'action': 'REVERT', 'reason': None, 'needsRestart': True, 'changeIds': ['576b0202-3a95-49c1-aeee-bfa208ffff6d'], 'opIds': []}] |
...
| history.json: one undo of the older Apply, its change REVERTED, the newer APPLIED | PASS | undo entries of these applies: ['9cb52b78-fb31-4703-a4ec-87bfa7c8a77a']; undo changes: [('disable', 'e2e-first-1.0.0.jar', 'APPLIED', '576b0202-3a95-49c1-aeee-bfa208ffff6d')]; older: {'576b0202-3a95-49c1-aeee-bfa208ffff6d': 'REVERTED'}; newer: {'e3f26626-967c-493f-a7b6-01e4d46b61ef': 'APPLIED'} |
