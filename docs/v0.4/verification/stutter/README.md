...
**C re-run on the RC (P5-C, 2026-09-27, after fix/review-8b's "chunks loading" tag):** [C-rerun/](C-rerun/README.md):
3 runs (C1r, C1r2, C3r), every post-teleport hitch "after teleport", "chunks loading" from the first chunk load after
the teleport on, no GC claim without an overlapping pause: **PASS** against AC5.8 C as amended (P5A-F2, P5C-F1).
