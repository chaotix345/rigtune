...
- **Benchmark history and regression alerts**: runs are compared only under the same conditions; a real drop in 1% lows is flagged with the changes since then listed as "may be related".
...
- **Estimated tier** instead of "limited by"; **VSync off** is optional, with honest text; MultiMC and GDLauncher are recognised.
