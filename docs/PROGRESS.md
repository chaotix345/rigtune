...
- [ ] Phase 2: SPEC committed (359e03b; item 6 PENDING the final jvm-gc.md), PLAN committed (a672e81: WS-K contracts, Wave A = A/R/P/S/J/B/W/F, Wave B = X a11y). RUNNING: WS-K contracts (feat/v04-contracts, C:/Dev/Worktrees/rigtune-contracts; C1-C7 skeletons + pinned v030 test copies) and the plan review (-> docs/v0.4/plan-review.md). Next: fold review into SPEC Amendments + PLAN, merge WS-K, create Wave A worktrees, launch Wave A.
- [ ] Phase 3/early Wave A RUNNING: WS-0 (feat/v04-foundation, C:/Dev/Worktrees/rigtune-found4: snapshot-canary.yml, the 2 //? if >=26.4-snapshot-1 patches, mod_version 0.4.0-dev) and WS-H (test/e2e-v04, C:/Dev/Worktrees/rigtune-e2e4: 0.3.0 old side, dry runs to 0.4.0-dev).
