...
- [ ] Phase 2: SPEC drafting RUNNING (agent spec -> docs/v0.4/SPEC.md from research + scratchpad/decisions.md). PLAN skeleton committed (969f6c8: Global Constraints, WS-0, WS-H). Next: review SPEC, contracts commit, rest of PLAN, plan review.
