...
// docs/v0.4/SPEC.md 4 (AC4.11). Registered by the contracts commit with one trivial case (RigTune -> Tools -> this screen -> Done) so CI proves
// the registration; WS-P extends it.
public class ProfilesGameTest implements FabricClientGameTest {
	...
	public void runTest(ClientGameTestContext context) {
		...
		context.waitForScreen(TitleScreen.class);
		RigTune.LOGGER.info("ProfilesGameTest: registered; the contracts skeleton case passed");
	}
}
